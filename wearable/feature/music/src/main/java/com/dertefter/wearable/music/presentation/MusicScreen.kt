...
import com.dertefter.wearable.music.presentation.content.ContentSuccess
...
@Composable
fun MusicScreen(onEvent: (Event) -> Unit, uiState: UiState, dialogState: PermissionDialogState) {
